...
* Features: WeatherAPI + Soil Moisture + Relay Pump + LCD + Blynk IoT App
* Author: Surya’s Project (2025)
**************************************************************/
 
#define BLYNK_TEMPLATE_ID "TMPL3HXGqMhtQ"  // optional for cloud linking
#define BLYNK_TEMPLATE_NAME "Irrigation"
#define BLYNK_AUTH_TOKEN "iTnXzBHIIwsoxjsNxS3MLKIGPx8ADxiy"
